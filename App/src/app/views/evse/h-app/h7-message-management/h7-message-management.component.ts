...
@Component({
  selector: 'app-h7-message-management',
  templateUrl: './h7-message-management.component.html',
  styleUrls: ['./h7-message-management.component.scss']
})
export class H7MessageManagementComponent extends BaseComponent implements OnInit {
  data: DataManager;
  modalReference: NgbModalRef;
  active = "Detail"

  @ViewChild('grid') public grid: GridComponent;
  model: MessageManagement = {} as MessageManagement;
  ...
  loadLang() {
    this.translate.get('MessageManagement').subscribe( functionName => {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}MessageManagement/LoadData?lang=${lang}`,
  ...
  cancel() {
    this.model = {} as MessageManagement;
    this.audit = {}
  }
  rowSelected(args) {
  ...
  fnEdit(data) {
    let link = `/h-app/h7/action/${data.id}`;
    this.router.navigateByUrl(link)
  }
  fnAdd() {
    let link = `/h-app/h7/action/${0}`;
    this.router.navigateByUrl(link)
  }
  fnSearch() {
