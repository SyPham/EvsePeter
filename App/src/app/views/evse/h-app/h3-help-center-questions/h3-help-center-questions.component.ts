...
@Component({
  selector: 'app-h3-help-center-questions',
  templateUrl: './h3-help-center-questions.component.html',
  styleUrls: ['./h3-help-center-questions.component.scss']
})
export class H3HelpCenterQuestionsComponent extends BaseComponent implements OnInit {
  data: DataManager;
  modalReference: NgbModalRef;
  active = "Detail"

  @ViewChild('grid') public grid: GridComponent;
  model: HelpCenter = {} as HelpCenter;
  ...
  loadLang() {
    this.translate.get('HelpCenter').subscribe( functionName => {
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}HelpCenter/LoadData?lang=${lang}`,
  ...
  fnEdit(data) {
    let link = `/h-app/h3/action/${data.id}`;
    this.router.navigateByUrl(link)
  }
  fnAdd() {
    let link = `/h-app/h3/action/${0}`;
    this.router.navigateByUrl(link)
  }
  fnSearch() {
