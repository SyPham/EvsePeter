...
import { ContractManagement } from 'src/app/_core/_model/evse/model';
import { ContractManagementService } from 'src/app/_core/_service/evse/contract-management.service';
import { ToolbarModule } from '@syncfusion/ej2-angular-navigations';
import { ToolbarType } from '@syncfusion/ej2-richtexteditor';
@Component({
  selector: 'app-h5-contract-management',
  templateUrl: './h5-contract-management.component.html',
  styleUrls: ['./h5-contract-management.component.scss']
})
export class H5ContractManagementComponent implements OnInit {

  loading
  model: ContractManagement = <ContractManagement>{};
